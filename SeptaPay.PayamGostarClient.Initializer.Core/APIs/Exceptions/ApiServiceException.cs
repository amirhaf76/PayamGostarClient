using SeptaPay.PayamGostarClient.Initializer.Core.APIs.Dtos.ExceptionDtos;
using System;
...
namespace SeptaPay.PayamGostarClient.Initializer.Core.APIs.Exceptions
{
    [Serializable]
    public class ApiServiceException : Exception
    {
        ...
        public static ApiServiceException Create(string message = "", string response = "", HttpStatusCode? statusCode = null, IReadOnlyDictionary<string, IEnumerable<string>> headers = null, ApiErrorDto apiError = null)
        {
            ...
            strBuilder.AppendLine(Helper.Help.WriteAsObject("Message:", message));

            strBuilder.AppendLine(Helper.Help.AddIndentation($"StatusCode: {statusCode}", 1));
            ...
            strBuilder.AppendLine(Helper.Help.WriteAsObject("Header:", $"{headerStrBuilder}"));
            strBuilder.AppendLine(Helper.Help.WriteAsObject("Response:", $"{response}"));
            strBuilder.AppendLine(Helper.Help.WriteAsObject("ApiError:", $"{apiError}"));
