...
namespace PayamGostarClient.Initializer.CreationStrategies
{
    internal class ExtendedPropertyCreationStrategy : IExtendedPropertyCreationStrategy
    {
        ...
        private async Task<PropertyGroup> CheckAndCreateGroupIfDoesNotExist(Guid crmObjectTypeId, IEnumerable<PropertyGroupGetResultDto> existedGroups, IGrouping<CrmModels.PropertyGroup, BaseExtendedPropertyModel> groupedPropertiesAndGroup)
        {
            //fetch group by name
