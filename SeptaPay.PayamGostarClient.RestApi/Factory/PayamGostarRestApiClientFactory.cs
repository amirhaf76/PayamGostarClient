...
namespace SeptaPay.PayamGostarClient.RestApi.Factory
{
    public class PayamGostarRestApiClientFactory : IPayamGostarRestApiClientFactory
    {
        private readonly PayamGostarRestApiConfig _config;

        public PayamGostarRestApiClientFactory(PayamGostarRestApiConfig config)
        {
            _config = config;
        }
