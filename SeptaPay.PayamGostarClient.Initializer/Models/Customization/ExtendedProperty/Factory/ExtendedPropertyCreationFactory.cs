using SeptaPay.PayamGostarClient.Initializer.Core.APIs.Abstractions.Customization.ExtendedProperty.ExtendedPropertyCreation;
...
namespace SeptaPay.PayamGostarClient.Initializer.Models.Customization.ExtendedProperty.Factory
{
    internal class ExtendedPropertyCreationFactory : IExtendedPropertyCreationFactory
    {
        ...
        private class AppointmentExtendedPropertyCreation : BaseExtendedPropertyCreation<CrmItemExtendedPropertyCreationDto>
        {
            ...
            public override async Task<SwaggerResponse<PropertyDefinitionPostResultVM>> CreatePropertyCreationActionAsync()
            {
                ...
                {
                    throw e.CreateApiServiceException(Core.Helper.Help.GetStringsFromProperties(Property));
                }
