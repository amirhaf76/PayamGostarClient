...
namespace Septa.PayamGostarClient.Initializer.Extension
{
    public static class BaseApiServiceExtension
    {
        ...
        private static ExtendedPropertyExtraConfigDto CastOrDefault(this PropertyDefinitionExtraConfigs config, Gp_PropertyDisplayType displaytype)
        {
            switch (displaytype)
            {
        ...
        public static ExtendedPropertyGetResultDto ToDto(this PropertyDefinitionGetResultVM extendedProperty)
        {
            return new ExtendedPropertyGetResultDto
            {
                ...
                ExtraConfig = extendedProperty.ExtraConfiguration.CastOrDefault((Gp_PropertyDisplayType)extendedProperty.PropertyDisplayTypeIndex),
            };
        }
